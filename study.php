	...
	<tr>
		...
		<td id="sideContent" width="168px">
  			<table>
  				...
  				<tr class="H160"><td id="img_side_ownerIcon"><div id="div_ownerIcon"><img alt="user image" id="img_userIcon" src="<?php if(isset($_SESSION['userpic'])){echo($_SESSION['userpic']);}?>" width="110px" height="104px" class="img_ownerPic"/></div><div><a id="a_showEditInfo"></a></div></td></tr>
  				...
  				<tr>
  					<td>
  						<table id="mainContentTop">
			  				<tr><td class="bg_TopWhite765"><img alt="top message box"  src="_images/study/title_TopStudyPageBox.png" width="820" /></td></tr>
			  				<tr>
			  					<td class="bg_middleWhite765">
			  						<table id="tr_messageBox_Page1">
			  							...
			  							<tr>
			  								<td>
			  								<label class="label_loading"><img alt="loading" src="_images/bg/bigloading.gif" /></label>
			  									<label class="font15 vertAlign_top padTop5" >
												<?php if($_ulevel >50){ ?>
													<a target="_blank" href="http://helenkwong.me/portfolio/share/admin.php?id=<?php echo($_userKey) ?>" >Go to Administrator Page</a>
												<?php } ?>
												</label>
			  				...
			  				<tr><td>
			  					<form id="form_newGp" class="display_none" action="">
				  					<table class="bg_white roundEdge6 text_justify font15 vertAlign_top padTop5" id="table_newGp">
...
<div id="div_try_Scratch" style="display:none">
	<table id="table_try_Scratch">
		<tr class="non_fullscreen">
			<td class="W100"><a id="btn_fullscreen"></a></td>
			<td class="W100"><a id="btn_like"></a></td>
			<td class="W300"><a id="btn_tocomment"></a></td>
			<td ><a class="btn_close popupClose"></a></td>
		</tr>
		<tr>
			<td colspan="3" id="td_scratch" class="roundEdge6"><label class="Scratch_loading display_none"><img alt="loading" src="_images/bg/bigloading.gif" /></label><iframe id="iframe_Scratch" allowtransparency ="true" class="normal" src="" frameborder="0" allowfullscreen></iframe></td>
			<td><a class="btn_quitFullScreen fullscreen display_none" id="btn_quitFullScreen"></a>
			<div id="div_comment" class="non_fullscreen"><div id="title_comment"></div><textarea class="font15" id="textarea_quickCommment"  placeholder="I want to comment about..." cols="" rows="" ></textarea><br />
			<?php if($_ulevel>5){ ?>
			<a id="btn_submit_comment"></a><span id="span_quickComment" class="error_msg font_grey display_none">Thank you!</span>
			<div class="div_comment_hints font15 non_fullscreen"><a>Good!</a><a>Interesting!</a><a>Too easy!</a><a>I dont understand.</a><a>Beautiful!</a><a>Enjoy!</a><a>How do we play the game?</a><a>Problem..</a><a>Add more sound effects</a><a>Cheer up！</a><a>Looking forward to the project!</a></div>
			<div><img alt="background image" src="_images/bg/think.png" class="non_fullscreen"/></div>
			<?php }else{ ?>
